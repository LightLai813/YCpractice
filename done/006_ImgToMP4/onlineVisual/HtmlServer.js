...
//     auth : {
//         user : 'AKIAJKNFXQ67YYG5RGQA',
//         pass : 'AiPmoaCcC1Y0QHjYtgs2hz+ZWThLGdVhcVfMCFD+S/vb'
//     }
// }));
// var smtpTransport = nodemailer.createTransport(smtpTransport({
//     host : '10.0.4.12',
...
app.get('/userVideo.html', function(req,res){
    var realpath = __dirname + '/userVideo.html';
    res.writeHead(200,{'Content-Type':mime.lookup(realpath)});
    res.end(fs.readFileSync(realpath));
});
