...
// ------------------------------------------------------------------------
//
// jQuery(selector).wipetouch(config);
//
...
(function (jQuery)
{
	jQuery.fn.wipetouch = function (settings)
	{
		...
		this.each(function ()
		{
			...
			function onTouchStart(e)
			{
				...
				if (!isMoving && start)
				{
					...
					if (useMouseEvents)
					{
						...
						jQuery(this).bind("mousemove", onTouchMove);
						jQuery(this).one("mouseup", onTouchEnd);
					}
					else
					{
						...
						jQuery(this).bind("touchmove", onTouchMove);
					}
					...
					touchedElement = jQuery(e.target);
				}
			}
			...
			{
				jQuery(this).bind("touchstart", onTouchStart);
				jQuery(this).bind("touchend", onTouchEnd);
			}
			else
			{
				useMouseEvents = true;

				jQuery(this).bind("mousedown", onTouchStart);
				jQuery(this).bind("mouseout", onTouchEnd);
			}
		});
